%
%   $Id: arosunits.tex,v 1.3 2004/12/30 14:13:47 michael Exp $
%   This file is part of the FPC documentation.
%   Copyright (C) 1997, by Michael Van Canneyt
%                 2015, by Marcus Sackrow (from rtl.tex)
%
...
\begin{latexonly}
  \ifpdf
      \hypersetup{
           pdfauthor={Marcus Sackrow},
           pdftitle={AROS units reference guide},
           pdfsubject={FPC AROS units: Reference guide},
...
%
\begin{document}
\title{AROSUnits (AROS) : \\ Reference guide.}
\label{arosunits}
\docdescription{Free Pascal version \fpcversion:\\ Reference guide for AROS units.}
\docversion{0.1}
%\input{date.inc}
...
procedures as they are declared in the AROS units standard library units.
